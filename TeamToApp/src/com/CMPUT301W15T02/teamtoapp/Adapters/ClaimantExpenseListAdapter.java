...
public class ClaimantExpenseListAdapter extends ArrayAdapter<Expense> {
	...
	private class ViewHolder {
		...
		//TextView claimantPhotoReceiptTextView; // Should say yes/or no if it exists.
	}
	/**
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (row == null) {
			...
			//holder.claimantPhotoReceiptTextView = (TextView) row.findViewById(R.id.claimantPhotoReceiptTextView);
			row.setTag(holder);
